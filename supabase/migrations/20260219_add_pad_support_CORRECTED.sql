-- Canadian PAD Payment Support Migration (CORRECTED)
...
-- =====================================================
-- 2. UPDATE rental_payments TABLE (CORRECTED TABLE NAME)
-- =====================================================
...
AND indexname LIKE '%pad%' OR indexname LIKE '%payment_type%' OR indexname LIKE '%mandate%';
*/
