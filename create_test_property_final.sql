-- Check Properties Table Structure First
-- Then create test data with correct columns
...
-- Step 2: Get an existing user ID from the properties
SELECT 
...
-- Step 3: Use the existing user ID to create test data
...
-- Step 4: Create a test property linked to this existing user (without is_active)
