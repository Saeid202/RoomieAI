-- ============================================
-- BROKER FEEDBACK SYSTEM MIGRATION (FIXED)
...
DROP TRIGGER IF EXISTS update_mortgage_feedback_timestamp ON mortgage_profile_feedback;
...
DROP TRIGGER IF EXISTS update_review_status_on_feedback ON mortgage_profile_feedback;
...
DO $$
BEGIN
    RAISE NOTICE '✅ Broker Feedback System migration completed successfully!';
    RAISE NOTICE 'Created: mortgage_profile_feedback table';
    RAISE NOTICE 'Added: review_status, last_reviewed_at, last_reviewed_by columns to mortgage_profiles';
    RAISE NOTICE 'Created: 4 RLS policies for security';
    RAISE NOTICE 'Created: 2 triggers for auto-updates';
