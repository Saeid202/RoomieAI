          ...
          <div className="max-w-4xl mx-auto space-y-12">
            ...
            <section className="text-center">
              ...
              <p className="text-gray-700">
                If you witness a violation of these guidelines, please report it immediately through the platform or by contacting <a href="mailto:community@roomieai.com" className="text-roomie-purple hover:underline">community@roomieai.com</a>.
              </p>
            </section>
          </div>
        </div>
