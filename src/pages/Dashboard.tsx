...
import { Bot, BookText, Brain, CheckCircle, Computer, HeartHandshake, Home, Info, LightbulbIcon, Monitor, PlayCircle, Users } from "lucide-react";
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <Card>
                      <CardContent className="p-6">
                        ...
                        <p className="text-sm">
                          Get access to roommate agreements, co-ownership contracts, and legal assistance to 
