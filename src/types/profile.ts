...
export const profileSchema = z.object({
  ...
  ageRangePreference: z.array(z.number()).min(2).max(2),
  ...
  dietaryPreferences: z.enum(["vegetarian", "halal", "kosher", "others", "noPreference"]),
  ...
  ethnicityPreference: z.enum(["same", "noPreference", "others"]),
  ethnicityOther: z.string().optional(),
  religionPreference: z.enum(["same", "noPreference", "others"]),
  religionOther: z.string().optional(),
  petPreference: z.enum(["noPets", "catOk", "smallPetsOk"]),
  petSpecification: z.string().optional(),
  smokingPreference: z.enum(["noSmoking", "noVaping", "socialOk"]),
