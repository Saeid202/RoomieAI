...
export function DashboardContent() {
  ...
  useEffect(() => {
    console.log("DashboardContent - Current path:", path);
  }, [path]);
  return (
    <div className="space-y-4">
      <h1 className="text-xl md:text-3xl font-bold tracking-tight ">Home</h1>
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6  bg-white p-3 rounded-lg shadow-sm border">
          {/* Welcome Panel */}
