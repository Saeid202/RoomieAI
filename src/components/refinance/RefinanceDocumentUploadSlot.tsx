...
import type { DocumentTypeConfig, RefinanceDocumentCategory, RefinanceDocument } from '@/types/refinanceDocument';
import {
  uploadDocument,
  deleteDocument,
  getDocumentUrl,
...
interface RefinanceDocumentUploadSlotProps {
  documentType: DocumentTypeConfig;
  category: RefinanceDocumentCategory;
  mortgageProfileId: string;
  existingDocument?: RefinanceDocument;
  onDocumentUploaded: () => void;
  onDocumentDeleted: () => void;
}

export function RefinanceDocumentUploadSlot({
  documentType,
  category,
  mortgageProfileId,
  existingDocument,
  onDocumentUploaded,
  onDocumentDeleted
}: RefinanceDocumentUploadSlotProps) {
