-- Check if rental_documents table exists and its structure
-- This script helps debug the document visibility issue
...
SELECT name, public FROM storage.buckets WHERE name = 'rental-documents';
